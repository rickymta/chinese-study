...
/// MỘT LẦN cho toàn bộ collection — tự Skip nếu thiếu AF_TEST_PG. Seed KHÔNG kèm BootstrapEmails ở
/// đây (chưa có user nào tồn tại lúc fixture chạy) — bootstrap admin cho user MỚI provision do
/// chính app xử lý lúc chạy test (xem CmsDbApiFactory.BootstrapAdminEmail).
/// </summary>
