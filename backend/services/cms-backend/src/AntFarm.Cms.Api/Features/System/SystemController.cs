...
namespace AntFarm.Cms.Api.Features.System;

/// <summary>GET /api/system/info — kiểm tra service sống + biết đang chạy phiên bản/môi trường nào.
/// AllowAnonymous tường minh — FallbackPolicy của service yêu cầu đăng nhập.</summary>
[ApiController]
[Route("api/system")]
[AllowAnonymous]
