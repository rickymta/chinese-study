...
namespace AntFarm.Chinese.Api.Middleware;

/// <summary>
/// Provision/đồng bộ người dùng (R-P4) NGAY SAU xác thực (UseAuthentication) và TRƯỚC phân
/// quyền (UseAuthorization) — bảo đảm access.users luôn có dòng trước khi
