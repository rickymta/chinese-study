...
/**
 * Cảnh báo rời trang khi còn thay đổi chưa lưu (hợp đồng §5.3.3): chặn điều hướng trong app bằng `useBlocker`
 * (cần data router — `createBrowserRouter`) + hộp `useConfirm`; đóng tab/tải lại bằng `beforeunload` (trình duyệt
 * hiện hộp chuẩn, không tuỳ biến được lời). Chỉ chặn khi ĐỔI PATHNAME — đổi `?tab=` cùng trang không tính.
 */
